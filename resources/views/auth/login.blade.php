...
<head>
  ...
  <meta name="keyword" content="Gestão de documentos, documentos, documents, gestão, gestao">
        ...
        <div class="row g-0">
          <div class="col-lg-6 d-none d-lg-flex justify-content-center align-items-center">
            <div style="max-width: 25rem;">
              <div class="mb-4">
                <img height="100" viewBox="0 0 67 20" fill="none" src="https://www.esika.ao/public/img/logo.png">
              ...
              <div class="mb-5">
                <h2 class="color-900">Neste Sistema Podes:</h2>
              </div>
              <!-- List Checked -->
              <ul class="list-unstyled mb-5">
                <li class="mb-4">
                  <span class="d-block mb-1 fs-4 fw-light">Verificar de forma:</span>
                  <span class="color-600">Eficiente, espectacular e ainda fazer o acompanhamento em tempo real</span>
                </li>
                <li>
                  <span class="d-block mb-1 fs-4 fw-light">Fácil de adicionar &amp; manejar seus documentos</span>
                </li>
              </ul>
              <div class="mb-2">
                <a href="/" class="me-3 color-600">Home</a>
                <a href="#" class="me-3 color-600">Sobre</a>
              ...
              {{ csrf_field() }}
                ...
                <div class="col-12">
                  <div class="mb-2">
                    ...
                    <input id="email" type="email" name="email" value="{{ old('email') }}"  class="form-control form-control-lg" placeholder="nome@example.com" required autofocus>
                  </div>
                </div>
                <div class="col-12">
                  <div class="mb-2">
                    <div class="form-label">
                      <span class="d-flex justify-content-between align-items-center"> Senha <a class="text-primary" href="auth-password-reset.html">Esqueceu a senha?</a>
                      </span>
                    </div>
                    <input id="password" type="password" name="password" required class="form-control form-control-lg" type="password" maxlength="10" placeholder="Escreva a tua senha">
                  </div>
                </div>
                <div class="col-12">
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                    <label class="form-check-label" for="flexCheckDefault"> Lembrar Sempre </label>
                  </div>
                </div>
                <div class="col-12 text-center mt-4">
                  <button class="btn btn-lg btn-block btn-dark lift text-uppercase" type="submit">Entrar</button>
                </div>
                <!--div class="col-12 text-center mt-4">
...
<!-- Mirrored from www.wrraptheme.com/templates/luno/auth-signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Feb 2023 15:46:10 GMT -->
</html>
