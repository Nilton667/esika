        ...
        <div class="d-flex flex-nowrap">
          <div class="order-1 custom_scroll">
            ...
            <li>   <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_customers" type="button">Novo Documento</button></li>
              ...
              <li><a class="m-link" href="/distribuicao"><i class="fa fa-send"></i><span>Distribuição</span></a></li>
                  ...
                  <nav class="navbar navbar-expand-md mt-2">
                    ...
                    <div class="collapse navbar-collapse order-0" id="inbox_page_header">
                      <ul class="navbar-nav flex-row me-auto">
                        ...
                        <li class="nav-item me-2"><a class="nav-link color-600" href="{{ route('distribuicao.users', $doc->id) }}"><i class="fa fa-arrow-circle-right"></i><span class="ms-2 d-none d-md-inline-block">Distribuir</span></a></li>
