...
@section('content')
	<div class="section">
		...
		<div class="col m11 s12">
			<div class="row">
				<h3 class="flow-text"> <strong> Distribuir:</strong> {{ $document->nome }} </h3>
            ...
            <div class="card fieldset border border-muted">
              <span class="fieldset-tile text-muted bg-body">Distribuir Para:</span>
              <form action="{{ route('documentosd.users.attach', $document->id) }}" method="POST">
                        @csrf	
