      ...
      <div class="inbox">
        <div class="d-flex flex-nowrap">
          <div class="order-1 custom_scroll">
            ...
            <li>   <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_customers" type="button">Expediente</button></li>
              <li><a class="m-link active" href="/documentos"><i class="fa fa-inbox"></i><span>Registo</span></a></li>
                  ...
                  <nav class="navbar navbar-expand-md mt-2">
                    ...
                    <div class="collapse navbar-collapse order-0" id="inbox_page_header">
                      <ul class="navbar-nav flex-row me-auto">
                        ...
                        <li class="nav-item me-2"><a class="nav-link color-600" href="{{ route('documentosd.users.available', $document->id) }}"><i class="fa fa-arrow-circle-right"></i><span class="ms-2 d-none d-md-inline-block">Distribuir Para Mais Funcionários</span></a></li>
