        ...
        <div class="d-flex flex-nowrap">
          <div class="order-1 custom_scroll">
            <ul class="menu-list list-unstyled mb-0">
              ...
              <li><a class="m-link" href="{{ route('armarios.show',$armario->id) }}"><i class="fa fa-inbox"></i><span>{{$armario->nome}}</span></a></li>
              @endforeach
            </ul>
          </div>
          ...
          <div class="col">
            <ol class="breadcrumb bg-transparent mb-0">
              ...
              <li class="breadcrumb-item active" aria-current="page"><a href="#">{{$armario->nome}}</a></li>
            </ol>
          </div>
        </div> 
              <div class="row g-3">
                  ...
                  @if(count($docs) > 0)
                    ...
                    <li class="row g-0 list-group-item d-flex align-items-start py-3">
                      <div class="hover-actions end-0 me-3 bg-light rounded">
                        <a href="/armario/{{ $doc->id }}/documento" class="btn btn-link btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Abrir"><i class="fa fa-inbox"></i></a>
                        <a href="{{ route('documentos.users', $doc->id) }}" class="btn btn-link btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Distribuir"><i class="fa fa-inbox"></i></a>
                        <!--a href="documentos/download/{{ $doc->id }}" class="btn btn-link btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Baixar"><i class="fa fa-trash"></i></a-->
                        <a href="#" class="btn btn-link btn-sm" data-bs-toggle="modal" data-bs-target="#edit_customers{{$doc->id}}"  data-bs-placement="top" title="Editar"><i class="fa fa-gear"></i></a>
                        <a href="#" class="btn btn-link btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Eliminar"><i class="fa fa-clock-o"></i></a>
                      </div>
                      ...
                      <div class="col col-md-9 col-xxl-10">
                        <div class="row">
                          <div class="col-md-4 col-xl-4 col-xxl-3 mb-1 mb-md-0">
                            <a href="/armario/{{ $doc->id }}/documento" class="d-flex text-primary text-truncate" title="Detalhes">
                              <div class="ms-2 mb-0">{{ $doc->origem }}</div>
                            </a>
                          </div>
                          <div class="col">
                            <p class="i-msg mb-0 text-muted">{{ $doc->nome }}</p>
